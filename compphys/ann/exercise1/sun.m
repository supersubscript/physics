...
[Pt,Tt] = loadsunspot(1, [1 3 7 9]);
[Pv,Tv] = loadsunspot(2, [1 3 7 9]); 
...
net.divideParam.trainInd = 1:231;            % The first Ndata will
                                                 % be training
net.divideParam.valInd = 232:315;   % The next Nval (1000) will be validation
